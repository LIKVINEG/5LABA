...
void mouse_callback(GLFWwindow* window, double xposIn, double yposIn) {
    ...
    float sens = 0.1f; yaw += xoffset * sens; pitch += yoffset * sens;
...
int main() {
    glfwInit();
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Lab 5 - Model Loading", NULL, NULL);
